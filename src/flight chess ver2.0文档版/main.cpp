...
// What you can do has been described above.
	...
	if (record_document) {
		god_mode = false;
		freopen("afc.out", "w", stdout);
		cout << "record document mode" << endl;
	}
...
int getDiceR() {
	...
	else cout << " dice number is " << rn + 1 << endl;
	return rn + 1;
}
...
int getAirplaneR(int i, int d) {
	...
	//if(!record_document) Sleep(1500); // pretend thinking
